...
Regularization (Alpha): Regularization was applied to control overfitting. The alpha parameter, which defines the strength of L2 regularization, was varied across different values. Higher values of alpha (0.1) showed a marked improvement in performance, reducing overfitting and boosting the model's ability to generalize. This was especially noticeable at higher resolutions, where the risk of overfitting is more pronounced due to the increased feature complexity.
